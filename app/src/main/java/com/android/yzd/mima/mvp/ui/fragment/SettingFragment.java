...
public class SettingFragment extends PreferenceFragment implements SettingAView{
    ...
    private SwitchPreference mAd_switch;
    ...
    public void showChangeThemeDialog() {
        ...
        int value = (int) SPUtils.get(getActivity(), getActivity().getResources().getString(R.string.change_theme_key), 2);
    ...
    public void findView() {
        ...
        mAd_switch = (SwitchPreference) findPreference("ad_switch");
    }

    @Override
    public void initState(boolean isOpen, boolean isOpenAd) {
        openGesture.setChecked(isOpen);
        if (mAd_switch != null) {
            mAd_switch.setChecked(isOpenAd);
        }
    }
